...
class CommonCookiesMiddleware:
	...
	def process_request(self, request, spider):
		...
		if not hasattr(spider, 'use_cookies'):
			return
		if not spider.use_cookies:
			return
	...
	def process_response(self, request, response, spider):
		...
		# Write cookies
		if common_settings.COOKIES_AUTO_UPDATE:
			cookies = []
			for cookie in self.jar:
	...
	def _debug_cookie(self, request, spider):
		if common_settings.COOKIES_DEBUG:
